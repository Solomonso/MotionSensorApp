//package com.example.motionsensorapp.dynamoUtil;
//
...
//            AmazonDynamoDBClientBuilder.standard().withCredentials(credentialsProvider).withRegion(DynamoConstants.REGION).build();
//
